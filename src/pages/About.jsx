...
<p className="font-mono px-5 py-10"
      ...
      <div className="relative flex overflow-x-hidden font-mono border-b-2 border-t-2 border-black">
        <div className="py-4 animate-marquee whitespace-nowrap">
          <Link to="https://github.com/claudiasgonz/project3-client" className="mx-4 hover:text-blue-600">
            github repo: frontend react app
          </Link>
          <span className="mx-4">♡</span>
          <Link to="https://github.com/claudiasgonz/project3-server" className="mx-4 hover:text-blue-600">
